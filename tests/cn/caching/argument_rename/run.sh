...
echo "=== Test: Argument Rename (should use cache with alpha-renaming) ==="
echo

rm -f .cn/verification.db foo.c

echo "1. Initial verification with foo_1.c (args: x, y):"
cp foo_1.c foo.c
...
echo "3. Change argument names (x→a, y→b) and re-run:"
cp foo_2.c foo.c
...
echo "✓ Test PASSED: Alpha-renaming working correctly"
